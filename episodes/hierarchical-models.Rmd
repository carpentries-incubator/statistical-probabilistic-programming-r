...
compiled_dir <- file.path(getwd(), "stan_compiled")
dir.create(compiled_dir, showWarnings = FALSE)

Sys.setenv(TMPDIR = compiled_dir)
Sys.setenv(TMP = compiled_dir)
Sys.setenv(TEMP = compiled_dir)

options(cmdstanr_write_stan_file_dir = compiled_dir)
options(cmdstanr_write_exe_dir = compiled_dir)

# Specialized knitr engine, Markdown compiler automatically save, compile to cmdstanr
